...
def ceas_measure(meastype,accums,exposure,shots,mfcaflow,mfcfflow):
    '''
    ...
    for i in range(meas_shots):
        ...
        I_not = np.average(zero[:,1:],axis=1).reshape(len(zero),1)
