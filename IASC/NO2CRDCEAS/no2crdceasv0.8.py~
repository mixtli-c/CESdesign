        ...
        case 'b':
            ...
            while crdsloop:
                ...
                for m in range(cyclescrds):
                    ...
                    np.savetxt(path_file + "MCz" + t1.strftime('%y%m%d%H%M') + '.txt',
                                np.column_stack((meastime,taus)), fmt='%s')
                    ...
                    np.savetxt(path_file + "MCm" + t1.strftime('%y%m%d%H%M') + '.txt',
                                np.column_stack((meastime,taus)), fmt='%s')
        ...
        case 'c':
            ...
            while ceasloop:
                ...
                for i in range(cycles):
                    ...
                    print('Sending instruction to CEAS PC...')
                    ###### this message requires the flow information
                    ...
                    meas_max_time = int(accums)*int(shots_meas)*float(exposure)
