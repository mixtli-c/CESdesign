...
extinction_w_ray(I_sample, I_0, Reff, distance,pPa,tK,sigma_ray)
fit_alg_1(I_sample,I_0,Reff,distance,reference1,reference2,verbose=1,parameters=0,choice=2)
fit_alg_1A(I_sample,I_0,Reff,distance,reference1,pPa,tK,sigma_ray,verbose=0,parameters=0,choice=2)
fit_alg_1A_it(I_sample,I_0,Reff,distance,reference1,pPa,tK,sigma_ray,verbose=1,parameters=0,choice=2)
fit_alg_1B(I_sample,I_0,Reff,distance,reference1,reference2,pPa,tK,sigma_ray,verbose=0,parameters=0,choice=2)
fit_alg_1B_it(I_sample,I_0,Reff,distance,reference1,reference2,pPa,tK,sigma_ray,verbose=0,parameters=0,choice=2,itn=10)
fit_alg_1C_it(I_sample,I_0,Reff,distance,reference1,reference2,reference3,pPa,tK,sigma_ray,verbose=0,parameters=0,choice=2,itn=10)
...
def andor_calibrator(length,intercept,c1,c2,c3):
    '''
    Similar as avantes_calibrator but for the andor CCD
    '''
    waves = []
...
def extinction_w_ray(I_sample, I_0, Reff, distance,pPa,tK,sigma_ray):
    """Calculates extinction spectrum"""
    I_ratio=(I_0/I_sample)
    #print(I_ratio.shape)
...
def fit_alg_1A(I_sample,I_0,Reff,distance,reference1,pPa,tK,sigma_ray,verbose=0,parameters=0,choice=2):
    """Fitting algorithm 1:
    Calculates the extinction, fits two references using SVD, then obtains a 
    parametric function, recalculates the original extinction with the two
    references and the parametric function
    ...
    alpha = extinction_w_ray(I_sample,I_0,Reff,distance,pPa,tK,sigma_ray)
...
def fit_alg_1B(I_sample,I_0,Reff,distance,reference1,reference2,pPa,tK,sigma_ray,verbose=0,parameters=0,choice=2):
    """Fitting algorithm 1:
    Calculates the extinction, fits two references using SVD, then obtains a 
    parametric function, recalculates the original extinction with the two
    references and the parametric function
